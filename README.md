...
Once the `conda-forge` channel has been enabled, `jupyterlab-favorites` can be installed with:

```
conda install jupyterlab-favorites
```

It is possible to list all of the versions of `jupyterlab-favorites` available on your platform with:
